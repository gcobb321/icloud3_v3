...
class iCloud3EventLogCard extends HTMLElement {
    ...
    setConfig(config) {
        ...
        btnConfig.innerHTML = `<svg width="24" height="24" viewBox="0 0 64 64" stroke="#47bda9" stroke-width="0">
