...
### Step #3.1 - iCloud Account & Login Credentials screen  {docsify-ignore}
...
### Step #3.2 - iCloud3 Device Tracker Entities screen  {docsify-ignore}
...
### Step #3.3 - Update Tracked iCloud3 Device screen  {docsify-ignore}
...
### Step #3.4 - Sensors selection screen
