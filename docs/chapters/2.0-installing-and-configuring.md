...
3. Copy all of the code in the above code block and past it into the Edit Configuration window. 
   ...
   - Copy the code below into the blank editor area. This code is for the *gary_iphone* device_tracker entity. Change all occurrences of *gary_iphone* to the iCloud3 device_tracker entity name for your phone you entered in the *Add Devices*  screen in step 3.3 above.
