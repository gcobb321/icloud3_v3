...
- Location data/time updates from the iOS App and iCloud data now shows how the data source was selected or rejected. 
- Added an icon to open the GitHub Issues web page for iCloud3.
